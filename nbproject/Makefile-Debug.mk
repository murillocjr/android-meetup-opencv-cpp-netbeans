...
# Object Files
OBJECTFILES= \
	${OBJECTDIR}/_ext/138dad10/SobelEdges.o \
	${OBJECTDIR}/main.o
...
${OBJECTDIR}/_ext/138dad10/SobelEdges.o: /home/oamakas/projects/cpp_projects/area_by_color/SobelEdges.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/138dad10
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/home/oamakas/projects/cpp_projects/ocv/opencv/include/opencv2 `pkg-config --cflags opencv`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/138dad10/SobelEdges.o /home/oamakas/projects/cpp_projects/area_by_color/SobelEdges.cpp
